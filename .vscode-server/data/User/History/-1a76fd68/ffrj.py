...
for state in states.states:
    cursor.execute('''
        INSERT INTO states 
        (icao24, callsign, origin_country, time_position, last_contact, longitude, latitude, altitude, 
    ...
    ''', (
        ...
        state.longitude, state.latitude, state.altitude, state.velocity, state.true_track, state.vertical_rate,
